...
export const FeedbackModal: React.FC<FeedbackModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async () => {
    if (!formData.rating || !formData.continueUsing) {
      alert("Please provide at least a rating and whether you'd like to continue using TheWorkMind.");
      return;
    }
  ...
  const DEPARTMENTS = [
    'HR', 'Finance', 'Marketing', 'Operations', 'IT Expert', 'Procurement', 'Leadership / Management', 'Customer Support', 'Sales', 'Other'
  ];
          ...
          <>
            ...
            {step === 'intro' && (
              <div className="flex-1 overflow-y-auto p-8 md:p-12 text-center custom-scrollbar">
                ...
                <h2 className="text-3xl font-black text-gray-900 mb-4 tracking-tight">Enjoying TheWorkMind?</h2>
                <div className="space-y-4 text-gray-600 text-lg mb-10 leading-relaxed">
                  <p>Thank you for using TheWorkMind.ai.</p>
            ...
            {step === 'form' && (
              <div className="flex flex-col flex-1 min-h-0">
                ...
                <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                  <div>
                    <h2 className="text-xl font-black text-gray-900">Help Us Improve TheWorkMind</h2>
                    <p className="text-xs text-gray-500 font-medium mt-0.5">Tell us what worked, what didn’t, and how you see TheWorkMind fitting in.</p>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-10 space-y-10 custom-scrollbar">
                  {/* Q1: Rating */}
                  <section>
                    <label className="block text-sm font-black text-gray-900 mb-4 uppercase tracking-wider">1. How would you rate your experience with TheWorkMind?</label>
                  ...
                  <section>
                    <label className="block text-sm font-black text-gray-900 mb-4 uppercase tracking-wider">2. What did you find most valuable about TheWorkMind?</label>
                  ...
                  {/* Q4: Departments */}
                  <section>
                    <label className="block text-sm font-black text-gray-900 mb-4 uppercase tracking-wider">4. Which departments would you use TheWorkMind for?</label>
                  ...
                  {/* Q5: Continue using */}
                  <section>
                    <label className="block text-sm font-black text-gray-900 mb-4 uppercase tracking-wider">5. Would you like to continue using TheWorkMind?</label>
                  ...
                  <section>
                    <label className="block text-sm font-black text-gray-900 mb-4 uppercase tracking-wider">8. What would make TheWorkMind a must-have for your business?</label>
                    <textarea
